...
function getConnection() {
	...
	global $db_Acrmnet_db_Url, $db_Acrmnet_db_User, $db_Acrmnet_db_Pass, $db_Acrmnet_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_Acrmnet_db_Url.";dbname=".$db_Acrmnet_db_DbName, $db_Acrmnet_db_User, $db_Acrmnet_db_Pass);
